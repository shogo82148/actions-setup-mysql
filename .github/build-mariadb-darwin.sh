...
(
    ...
    mkdir build
    cd build
    # 10.0.x only supports WITHOUT_PLUGIN_TOKUDB=1 style
    cmake "../mariadb-$MARIADB_VERSION" \
        ...
        -DWITHOUT_PLUGIN_TOKUDB=1 -DWITHOUT_PLUGIN_MROONGA=1 -DWITHOUT_PLUGIN_SPIDER=1 -DWITHOUT_PLUGIN_OQGRAPH=1 -DWITHOUT_PLUGIN_PERFSCHEMA=1 -DWITHOUT_PLUGIN_SPHINX=NO -DWITHOUT_PLUGIN_ARCHIVE=1 -DWITHOUT_PLUGIN_ROCKSDB=1
    make "-j$JOBS"
)
echo "::endgroup::"
