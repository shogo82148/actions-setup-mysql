...
const sep = path.sep;
function shutdownMySQL(state) {
    return __awaiter(this, void 0, void 0, function* () {
        yield core.group('shutdown MySQL Server', () => __awaiter(this, void 0, void 0, function* () {
            const env = {};
            const args = [
            ...
            yield exec.exec(path.join(state.toolPath, 'bin', `mysqladmin${binExt}`), [...args, `shutdown`], {
                env: env
            });
